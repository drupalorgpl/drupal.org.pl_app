...
#[FieldType(
  id: 'entity_reference_display',
  label: new TranslatableMarkup('Display mode'),
  description: new TranslatableMarkup('This field allows you to specify a display mode for entity reference field.'),
  category: 'reference',
  default_widget: 'options_select',
  default_formatter: 'list_default',
)]
